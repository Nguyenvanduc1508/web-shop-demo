    ...
    <div className="product-type">
      <div className="type-head">
        <div className="type-left">
          ...
          <span className="type-name">ĐỒNG HỒ NAM</span>
        </div>
        <div className="type-right">
          ...
          <select className="oderby">
            ...
            <option value='min'>Thứ tự đánh giá: thấp đến cao</option>
            <option value='max'>Thứ tự đánh giá: cao xuống thấp</option>
          </select>
        </div>
      </div>
